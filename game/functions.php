 ...
 *
 * @return bool (true = available, false = taken)
 */
...
function didAuctionMeetReserve($iid)
{
    ...
    while ($row = $userQuery->fetch()) {
        return  ($row['amt'] >= $row['reserve']) ? 1 : 0;
    }
}
 ...
 *
 * @return bool (true  = guess was correct for this user)
 */
 ...
 * @param aid The auction id
 *
 * @return bool (true = auction is in progress)
 */
 ...
 * @param aid The auction id
 *
 * @return bool (true = still happening)
 */
